...
export default function SecondRow() {
  return (
    <div className="conainer mx-auto">
      <div className="flex items-center justify-between px-10 flex-wrap mt-[80px] md:mt-[50px] xl:px-0">
        <div className="w-[300px] h-[300px] mt-[20px] mx-auto text-center bg-darkWhite flex flex-col items-center justify-center px-[15px] hover:bg-[#fff] cursor-pointer hover:drop-shadow duration-300">
          ...
          <p className={`${styles.informationText} text-textInfo mt-5 md:mt-3`}>
